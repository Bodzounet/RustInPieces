...
public class ParachuteLvl3 : Spells.ST_Instant
{
    protected override void DoAction()
    {
        ...
        _baseSpell.Caster.GetComponent<StrategistManager>().minionManager.CreateMinion(UnitsInfo.e_UnitType.TANK, _baseSpell.SpellPos, Quaternion.identity, lane);
        _baseSpell.Caster.GetComponent<StrategistManager>().minionManager.CreateMinion(UnitsInfo.e_UnitType.MEDIC, _baseSpell.SpellPos, Quaternion.identity, lane);
    }
}

...
/*SF_DATA;ver:1.26;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:True,hqlp:True,rprd:True,enco:False,rmgx:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:2,bsrc:3,bdst:7,dpts:2,wrdp:True,dith:2,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:False,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False;n:type:ShaderForge.SFN_Final,id:9123,x:32987,y:32692,varname:node_9123,prsc:2|diff-8824-OUT,spec-9061-OUT,gloss-1274-OUT,normal-7382-OUT,alpha-4142-OUT;n:type:ShaderForge.SFN_Tex2d,id:1035,x:31969,y:32217,ptovrint:False,ptlb:Diffuse Map (Trans A),ptin:_DiffuseMapTransA,varname:node_1035,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:8824,x:32239,y:32276,varname:node_8824,prsc:2|A-1035-RGB,B-9096-RGB;n:type:ShaderForge.SFN_Color,id:9096,x:31969,y:32390,ptovrint:False,ptlb:Diffuse color,ptin:_Diffusecolor,varname:node_9096,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Tex2d,id:3318,x:32520,y:33540,ptovrint:False,ptlb:Normal Map,ptin:_NormalMap,varname:node_3318,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Slider,id:3024,x:32363,y:33732,ptovrint:False,ptlb:Normal Intensity,ptin:_NormalIntensity,varname:node_3024,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:2;n:type:ShaderForge.SFN_Tex2d,id:9576,x:31549,y:32700,ptovrint:False,ptlb:Specular Map,ptin:_SpecularMap,varname:node_9576,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Color,id:3546,x:31916,y:32996,ptovrint:False,ptlb:Spec color,ptin:_Speccolor,varname:node_3546,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Multiply,id:1450,x:31891,y:32768,varname:node_1450,prsc:2|A-9576-RGB,B-7242-OUT;n:type:ShaderForge.SFN_Multiply,id:9061,x:32068,y:32828,varname:node_9061,prsc:2|A-1450-OUT,B-3546-RGB;n:type:ShaderForge.SFN_Slider,id:7242,x:31548,y:32966,ptovrint:False,ptlb:Spec Intensity,ptin:_SpecIntensity,varname:node_7242,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.5,max:2;n:type:ShaderForge.SFN_Slider,id:1274,x:32566,y:32086,ptovrint:False,ptlb:Gloss,ptin:_Gloss,varname:node_1274,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.3,max:1;n:type:ShaderForge.SFN_Slider,id:1750,x:32206,y:33166,ptovrint:False,ptlb:Transparency,ptin:_Transparency,varname:node_570,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.5,max:1;n:type:ShaderForge.SFN_Lerp,id:4142,x:32595,y:33072,varname:node_4142,prsc:2|A-7685-OUT,B-1035-A,T-1750-OUT;n:type:ShaderForge.SFN_Vector1,id:7685,x:32303,y:33047,varname:node_7685,prsc:2,v1:0;n:type:ShaderForge.SFN_Lerp,id:7382,x:32785,y:33443,varname:node_7382,prsc:2|A-744-OUT,B-3318-RGB,T-3024-OUT;n:type:ShaderForge.SFN_Vector3,id:744,x:32503,y:33408,varname:node_744,prsc:2,v1:0,v2:0,v3:1;proporder:9096-1035-3318-3024-9576-3546-7242-1274-1750;pass:END;sub:END;*/

Shader "Ciconia Studio/Double Sided/Transparent/Gradient Diffuse" {
    Properties {
...
/// Final Color:
                ...
                fixed4 finalRGBA = fixed4(finalColor,lerp(0.0,_DiffuseMapTransA_var.a,_Transparency - d.worldPos.y / (5.5 + 1 * sin(_Time.y) * sin(length(d.worldPos.xz)))));
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float4 _DiffuseMapTransA_var = tex2D(_DiffuseMapTransA,TRANSFORM_TEX(i.uv0, _DiffuseMapTransA));
                float3 diffColor = (_DiffuseMapTransA_var.rgb*_Diffusecolor.rgb);
                float4 _SpecularMap_var = tex2D(_SpecularMap,TRANSFORM_TEX(i.uv0, _SpecularMap));
